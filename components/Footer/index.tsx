        ...
        <div className="relative">
            ...
            <div className="bg-c-gray w-full min-h-150px px-5 pb-8 py-14">
                <div className="wrapper flex justify-between gap-5 [&_h4]:font-semibold  [&_h4]:mb-5">
                    <div>
                        <Link className="mb-3 block" href="/"><Image src="/images/logo.png" width={50} height={50} alt="image" /></Link>
                    ...
                    <div>
                        <h4>Planet Dekor</h4>
                        <ul className="[&_a]:block [&_a]:py-1">
                            <li><Link href="/">Area Jangkauan</Link></li>
                            <li><Link href="/">Tanya Harga</Link></li>
